export default function UserMarketLoading() {
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#05070d" }}>
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ fontFamily: "var(--font-jetbrains)", fontSize: "11px", letterSpacing: "0.18em", textTransform: "uppercase", color: "#7a8298", margin: 0 }}>Cargando cartas…</p>
      </div>
