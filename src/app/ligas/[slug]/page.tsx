...
export default async function LigaPage({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params;
  return (
    <main style={{ minHeight: "100vh", background: "#05070d", padding: "80px 48px" }}>
      <div style={{ fontFamily: MONO, fontSize: "11px", color: COURT, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "12px" }}>Liga</div>
      ...
      <div style={{ border: "1px dashed rgba(255,255,255,0.1)", borderRadius: "16px", padding: "80px 40px", textAlign: "center" }}>
        <p style={{ fontFamily: MONO, fontSize: "12px", color: INK2, letterSpacing: "0.1em", textTransform: "uppercase" }}>Página de la liga — Próximamente</p>
      </div>
    </main>
  );
}
